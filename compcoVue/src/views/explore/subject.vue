        ...
        <div class="exploreCompetitionsArea">
            ...
            <div v-for="(cat, index) in subCategories" :key="cat">
                ...
                <div v-else class="competitionPreviewArea">
                    <compPreview v-for="comp in subCategoryInfo[index]" :key="comp" :name="comp.name" :url="comp.url" :preview="comp.preview" :location="comp.location" :views="comp.views" :difficulty="comp.difficulty"></compPreview>
                </div>
            </div>
...
export default defineComponent({
    ...
    data(){
        return{
            ...
            category:"Subject",
            subCategoryInfo:[],
            subCategories:["Math","Chemistry","Computer Science","Economics","Business","Physics","Chinese","History","English","Innovation","Debate","Other"]
        }
    },
    methods:{
        redirectToComp(url) {
